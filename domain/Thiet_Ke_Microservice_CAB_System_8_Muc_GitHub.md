...
1.  [Phân tách Use Case theo miền nghiệp
    vụ](#1-phân-tách-use-case-theo-miền-nghiệp-vụ)
2.  [Ubiquitous Language](#2-ubiquitous-language)
3.  [Bounded Context và Context Map](#3-bounded-context-và-context-map)
4.  [Aggregate và invariant nghiệp
    vụ](#4-aggregate-và-invariant-nghiệp-vụ)
5.  [Domain Event phát sinh từ Use
    Case](#5-domain-event-phát-sinh-từ-use-case)
6.  [Ánh xạ Context sang
    Microservice](#6-ánh-xạ-context-sang-microservice)
7.  [Mô tả Service](#7-mô-tả-service)
8.  [Mô hình dữ liệu cho Service](#8-mô-hình-dữ-liệu-cho-service)
...
-   Notification hoặc Payment lỗi không được làm toàn bộ luồng
    Booking/Trip dừng theo kiểu lỗi dây chuyền.
...
-   Không dùng distributed transaction xuyên tất cả service; ưu tiên
    eventual consistency/Saga cho luồng dài.
